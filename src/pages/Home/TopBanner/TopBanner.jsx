    ...
    <div className="container mx-auto">
      ...
      <div className="flex justify-between items-start gap-10 mt-20">
        ...
        <div className="lg:w-1/2 mt-16">
          ...
          <p className="w-3/4 my-5">
            ...
            obcaecati maiores quae dicta atque pariatur labore officia alias
            neque repellendus!
          </p>

          <button className="btn rounded  bg-pink-500 border-0  hover:bg-pink-700 ">
            See Gallery
          </button>
        </div>
      </div>
      ...
      <div className="flex mx-auto justify-between items-start gap-10 mt-20">
        <div className="lg:w-1/2 mt-16 ps-12">
          ...
          <button className="btn rounded bg-cyan-500 border-0 hover:bg-cyan-700">
            Buy Toys
          </button>
        </div>
